<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <section
      class="filter-section py-8 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 backdrop-blur-sm bg-white/95 dark:bg-gray-800/95"
    >
        ...
        <div class="space-y-6">
          ...
          <div class="flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
            ...
            <div class="flex-1 max-w-lg">
              <div class="relative group">
                <UIcon
                  ...
                  class="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-focus-within:text-yellow-500 w-5 h-5 transition-colors"
                />
                <input
                  v-model="searchQuery"
                  type="text"
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4">
              ...
              <!-- Sort Options -->
              <div class="flex items-center gap-2 w-full sm:w-auto">
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300 hidden sm:block"
                  >Sort:</label
                >
                <USelectMenu
                  v-model="sortBy"
          ...
          <div
            ...
            class="flex flex-wrap items-center gap-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border border-yellow-200 dark:border-yellow-800"
          >
    ...
    <section class="py-10 lg:py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-if="backendLoading">
          <div
            v-for="category in ['Starters', 'Mains', 'Desserts']"
            :key="`skeleton-category-${category}`"
            class="mb-16"
          >
            <!-- Skeleton Category Header -->
            <div class="text-center mb-12">
              <div
                class="h-8 w-48 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mx-auto mb-4"
              />
              <div class="w-24 h-1 bg-gray-200 dark:bg-gray-700 mx-auto mb-4" />
              <div
                class="h-4 w-96 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mx-auto mb-2"
              />
              <div class="h-3 w-24 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mx-auto" />
            </div>
        ...
        <div v-else-if="filteredCategories.length > 0">
          <div v-for="category in filteredCategories" :key="category.id" class="mb-16">
            ...
            <div class="text-center mb-12">
              ...
              <div class="w-24 h-1 bg-yellow-500 mx-auto mb-4" />
              <p
            ...
            <div
              v-if="category.items?.length > itemsPerPage"
            ...
            >
              ...
              <div class="text-sm text-gray-600 dark:text-gray-400 flex items-center gap-2">
                ...
                <span>
                  Showing {{ (paginatedItems(category).currentPage - 1) * itemsPerPage + 1 }}-{{
                    Math.min(
                      paginatedItems(category).currentPage * itemsPerPage,
                      paginatedItems(category).totalItems
                    )
                  }}
        ...
        <UCard v-if="selectedItem">
          <template #header>
            <div class="relative overflow-hidden rounded-t-lg">
              <template
                v-if="selectedItem && selectedItem.images && selectedItem.images.length > 1"
              >
                <div class="relative w-full h-48 lg:h-64">
                  ...
                  <div class="absolute bottom-3 left-1/2 transform -translate-x-1/2 flex gap-2">
                    <span
                      ...
                      :class="
                        carouselIndex === idx ? 'bg-yellow-500' : 'bg-gray-300 hover:bg-gray-400'
                      "
          ...
          <div class="p-6 lg:p-8 space-y-6">
            ...
            <div class="flex flex-col lg:flex-row justify-between lg:items-start gap-4">
              ...
              <div class="lg:text-right">
                <div
                  v-if="selectedItem.price && selectedItem.price > 0"
          ...
          <template #footer>
            <div class="flex justify-end gap-3">
              <UButton color="gray" variant="outline" @click="closeModal"> Close </UButton>
            </div>
          </template>
        </UCard>
      </div>
    ...
    <section class="py-16 bg-white dark:bg-gray-800 relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div class="w-16 h-1 bg-yellow-500 mx-auto mb-8" />
        <p class="text-lg lg:text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-3xl mx-auto">
          We cater to various dietary requirements. Please ask our staff for detailed allergen
          information.
        </p>
    ...
    <UModal v-model="isCategoryModalOpen" class="z-50">
      <div class="max-w-4xl w-full mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="text-right mt-6">
          <UButton color="yellow" variant="outline" @click="isCategoryModalOpen = false">
            Close
          </UButton>
        </div>
      </div>
...
const { preloadImage, isVisible, metrics } = usePerformance()
...
const sortedCategories = computed(() => {
  ...
  categories.value.forEach(category => {
    ...
    const isDailySpecial =
      categoryName.includes('special') && dayOrder.some(day => categoryName.includes(day))
...
const sortItems = (items: MenuItem[]) => {
  ...
  return availabilityFilter.value === 'sold-out'
    ? soldOutItems
...
const previousImage = () => {
  if (selectedItem.value?.images && selectedItem.value.images.length > 1) {
    carouselIndex.value =
      carouselIndex.value === 0 ? selectedItem.value.images.length - 1 : carouselIndex.value - 1
  }
}
...
watch(isModalOpen, isOpen => {
  if (isOpen && selectedItem.value?.images && selectedItem.value.images.length > 1) {
...
watch(
  [activeCategory, searchQuery, availabilityFilter, sortBy],
  () => {
