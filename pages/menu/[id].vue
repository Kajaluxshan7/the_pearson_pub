...
// Image carousel
const previousImage = () => {
  if (!menuItem.value?.images) {
    return
  }
  currentImageIndex.value =
    currentImageIndex.value === 0 ? menuItem.value.images.length - 1 : currentImageIndex.value - 1
}
...
const nextImage = () => {
  ...
  currentImageIndex.value = (currentImageIndex.value + 1) % menuItem.value.images.length
}
