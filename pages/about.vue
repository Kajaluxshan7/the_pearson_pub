<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <!-- Hero Section -->
    <section
      class="relative py-36 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden"
    >
      <div class="absolute inset-0">
        <NuxtImg
          ...
          quality="80"
        />
        <div class="absolute inset-0 bg-gradient-to-r from-black/80 to-black/60" />
      </div>

      <!-- Decorative Elements -->
      <div
        class="absolute top-10 right-10 w-24 h-24 rounded-full border border-yellow-500/30 animate-pulse"
      />
      <div class="absolute bottom-20 left-10 w-32 h-32 rounded-full bg-yellow-500/20" />

      <div class="hero-content relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        <div class="inline-block mb-4">
          <span class="text-yellow-400 font-semibold text-lg tracking-wide uppercase"
            >Heritage & Values</span
          >
        ...
        <p class="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
          Discover the <span class="text-yellow-300">heritage</span> and
          <span class="text-yellow-300">heart</span> behind The Pearson Pub
        </p>
      </div>
    </section>
    <!-- History Section -->
    ...
    >
      ...
      <div class="absolute inset-0 opacity-5">
        <div class="absolute top-20 left-10 w-48 h-48 rounded-full border-2 border-yellow-500" />
        <div class="absolute bottom-20 right-20 w-32 h-32 rounded-full bg-yellow-300" />
      </div>
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div class="space-y-8">
            ...
            <div class="space-y-6">
              <p class="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                Founded in the heart of the Whitby community, The Pearson Pub has been a gathering
                place for friends and families since our doors first opened.
              </p>
              <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                What started as a traditional English pub has evolved into a modern establishment
                that perfectly balances timeless charm with contemporary comfort. We've maintained
                our commitment to quality food, exceptional service, and creating memorable
                experiences for every guest who walks through our doors.
              </p>
              <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                Over the years, we've become more than just a pub – we're a cornerstone of the
                community, hosting celebrations, gatherings, and creating countless memories for
          ...
          <div class="relative group">
            ...
            <div
              class="absolute -bottom-8 -left-8 bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 max-w-sm transform hover:scale-105 transition-transform duration-300"
            >
    ...
    <section class="py-20 bg-gray-50 dark:bg-gray-800 relative overflow-hidden">
      <!-- Background decorations -->
      <div class="absolute inset-0 opacity-5">
        <div class="absolute top-20 right-10 w-48 h-48 rounded-full border-2 border-yellow-500" />
        <div class="absolute bottom-20 left-10 w-32 h-32 rounded-full bg-yellow-300" />
      </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div v-if="storiesLoading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div
              class="w-full h-full bg-gradient-to-t from-gray-300 to-gray-200 dark:from-gray-600 dark:to-gray-700"
            />
            <div class="absolute bottom-0 left-0 right-0 p-6">
              <div class="h-4 bg-gray-300 dark:bg-gray-600 rounded mb-2" />
              <div class="h-6 bg-gray-300 dark:bg-gray-600 rounded mb-2" />
              <div class="h-12 bg-gray-300 dark:bg-gray-600 rounded" />
            </div>
          </div>
        </div>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div class="relative h-100 overflow-hidden">
              ...
              />
              <div
                class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-80 group-hover:opacity-95 transition-opacity duration-300"
              />
              ...
              >
                <div
                  ...
                  :class="
                    index === (currentImageIndexes[story.id] || 0) ? 'bg-yellow-400' : 'bg-white/50'
                  "
                />
              </div>
              ...
              >
                <div
                  class="w-10 h-10 bg-yellow-500 rounded-full flex items-center justify-center shadow-lg"
                >
            ...
            <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
              ...
              <h3
                class="text-2xl font-bold mb-3 group-hover:text-yellow-300 transition-colors leading-tight"
              >
                {{ story.title }}
              </h3>
              <div class="flex items-center justify-between mt-4">
                <!-- Read More Text -->
                <div
                  class="flex items-center justify-end text-yellow-400 text-sm font-medium w-full"
                >
    ...
    >
      <!-- Background decorations -->
      <div class="absolute inset-0 opacity-5">
        <div class="absolute top-10 left-10 w-40 h-40 rounded-full border-2 border-yellow-500" />
        <div class="absolute bottom-10 right-10 w-32 h-32 rounded-full bg-yellow-300" />
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div class="relative mb-6">
              <div
                class="w-20 h-20 bg-yellow-500/10 rounded-full flex items-center justify-center mx-auto group-hover:bg-yellow-500/20 transition-colors duration-300"
              >
                <UIcon
                  :name="value.icon"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div class="relative mb-6">
              <div
                class="w-24 h-24 bg-yellow-500 rounded-full flex items-center justify-center mx-auto"
              >
                <UIcon :name="member.icon" class="w-12 h-12 text-white" />
              </div>
            </div>
  ...
  <!-- Story Modal -->
  <StoryModal v-model="isModalOpen" :story-id="selectedStoryId" />
</template>
...
const getStorySubtitle = (story: ApiStory) => {
  ...
  const subtitle =
    story.description.length > 50 ? story.description.substring(0, 50) + '...' : story.description
...
const values = [
  ...
  },
  {
    ...
    title: 'Quality',
    description:
      'Excellence in every pour and plate, using only the finest ingredients and techniques'
  },
  {
  ...
  meta: [
    {
      name: 'description',
      content:
        "Learn about The Pearson Pub's heritage, values, and the passionate team behind our exceptional service."
    }
  ]
})
</script>
