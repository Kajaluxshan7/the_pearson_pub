    ...
    >
      ...
      <div class="hero-content relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        <p class="text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed">
          Get in touch with us for <span class="text-yellow-300">reservations</span>,
          <span class="text-yellow-300">inquiries</span>, or
          <span class="text-yellow-300">feedback</span>
        </p>
      </div>
    </section>
    ...
    <section class="py-20">
      <div class="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div class="space-y-6">
              ...
              >
                <div class="flex-shrink-0">
                  <div
                    class="w-12 h-12 bg-yellow-500/10 rounded-full flex items-center justify-center group-hover:bg-yellow-500/20 transition-colors duration-300"
                  >
                ...
                <div class="flex-1">
                  <h3
                    class="font-bold text-lg text-gray-900 dark:text-white group-hover:text-yellow-600 dark:group-hover:text-yellow-400 transition-colors"
                  >
                    {{ item.title }}
                  </h3>
                  ...
                  <p v-if="item.extra" class="text-gray-500 dark:text-gray-400 text-sm mt-1">
                    {{ item.extra }}
                  </p>
                </div>
              </div>
          ...
          <!-- Contact Form -->
          <div ref="formRef" class="">
            <!-- Quick Links -->
            <div
              class="bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 rounded-2xl p-6 mb-16 mt-10 border border-yellow-200 dark:border-yellow-800"
            >
              <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Quick Actions</h3>
              <div class="flex flex-wrap gap-4">
                <UButton to="/menu" color="yellow" variant="outline" size="lg"> View Menu </UButton>
                <UButton to="/events" color="yellow" variant="outline" size="lg">
                  See Events
                </UButton>
              </div>
            </div>
              ...
              <form novalidate class="space-y-6" @submit.prevent="submitForm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <UFormGroup label="First Name" required :error="formErrors.firstName">
                    <UInput
                      ...
                      size="lg"
                    />
                    <p v-if="formErrors.firstName" class="text-red-600 text-sm mt-1">
                  ...
                  <UFormGroup label="Last Name" required :error="formErrors.lastName">
                    <UInput
                      ...
                      size="lg"
                    />
                    <p v-if="formErrors.lastName" class="text-red-600 text-sm mt-1">
                      {{ formErrors.lastName }}
                    </p>
                  </UFormGroup>
                </div>
                ...
                <UFormGroup label="Subject" required :error="formErrors.subject">
                  <UInput
                    ...
                    size="lg"
                  />
                  <p v-if="formErrors.subject" class="text-red-600 text-sm mt-1">
                    {{ formErrors.subject }}
                  </p>
                </UFormGroup>
    ...
    <section class="py-14 bg-white dark:bg-gray-800 relative overflow-hidden">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="bg-gray-100 dark:bg-gray-700 rounded-2xl p-3 shadow-xl">
          <div
            class="aspect-video bg-gray-200 dark:bg-gray-600 rounded-xl flex items-center justify-center"
          >
            <iframe
...
// Backend integration
const { contactInfo: backendContactInfo, operationHours, fetchContactInfo } = useLandingPageData()
  ...
  meta: [
    {
      name: 'description',
      content:
        'Get in touch with The Pearson Pub. Contact us for reservations, inquiries, or feedback.'
    }
  ]
})
</script>
